        ...
        @endif
            <div class="row ">
                <div class="col-md-12 col-lg-12">
                    ...
                    <form  id="item-form" action="{{ route('transfer.update',$transfer->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <strong>Invoice No:</strong>
                                        <input  placeholder="Invoice number" value="{{ $transfer->invoice_no }}"  type="number" name="invoice_no" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="Not select">Choose</option>
                                      ...
                                      @foreach ($commission as $commissions)
                                          <option value="{{ $commissions->id}}" {{ $transfer->commission_agent_id == $commissions->id ? 'selected' : '' }}>{{ $commissions->name}}</option>
                                      @endforeach
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <strong>Date:</strong>
                            <input type="date" value="{{ date('Y-m-d') }}" value="{{ $transfer->date }}"  required name="date" class="form-control">
                        </div>
                    </div>
            ...
            <div id="field-container">
                ...
                <div class="row field-row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="border_warehouse_id[]" class="form-control border-warehouse-select">
                                ...
                                <option value="{{ $warehouse_borders->warehouseborder->id }}"  {{ $transfer->border_warehouse_id == $warehouse_borders->warehouseborder->id ? 'selected' : '' }}>{{ $warehouse_borders->warehouseborder->name }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="warehouse_id[]" required class="form-control">
                                @foreach ($warehouse as $warehouses)
                                    <option value="{{ $warehouses->id }}" {{ $transfer->warehouse_id == $warehouses->id ? 'selected' : '' }}>{{ $warehouses->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <strong>Fine:</strong>
                            <input type="number"   value="{{ $transfer->fine_quantity }}" name="fine_quantity[]" id="fine-quantity" placeholder="Fine Quantity" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="number"  value="{{ $transfer->demage_quantity }}"  name="demage_quantity[]" id="damage-quantity" placeholder="Damage Quantity" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <strong>Loss:</strong>
                            <input type="number"  value="{{ $transfer->loss_quantity }}"  name="loss_quantity[]" id="loss-quantity" placeholder="Loss Quantity" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-2">
