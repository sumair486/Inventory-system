            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                {{-- <h4 class="card-title">  <a class="btn btn-success" href="{{ route('customer.create') }}"> Create Customer</a></h4> --}}
                            </div><!--end card-header-->
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="datatable_1">
                                        ...
                                        <tbody>
                                            @foreach ($warehouse_stock as $key=>$warehouse_stocks)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                {{-- <td>{{ $transfers->commissions->name ?? 'none'}}</td> --}}
                                              
                                                <td>{{ $warehouse_stocks->warehouse->name ?? '' }}</td>
                                                <td>{{ $warehouse_stocks->products->product_name ?? '' }}</td>
                                                <td>{{ number_format($warehouse_stocks->total_fine_quantity) }}</td>
                                                <td>{{ $warehouse_stocks->total_demage_quantity }}</td>
                                                <td>{{ $warehouse_stocks->total_loss_quantity }}</td>    

                                                {{-- <td>{{ $warehouse_stocks->stock_date }}</td>     --}}
                                                ...
                                                <td>
                                                    <form action="{{ route('warehouse-stock.delete',$warehouse_stocks->id) }}" method="POST">
