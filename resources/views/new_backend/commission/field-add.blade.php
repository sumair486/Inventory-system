        ...
        @endif
            <div class="row ">
                <div class="col-md-12 col-lg-12">
                    ...
                    <form action="{{ route('commission_ledger.save',['commission_ledger' => $commission_ledger]) }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="number" placeholder="Remaining Quantity" name="delivered_quantity" class="form-control">
                              </div>
                          </div>
                          {{-- <div class="col-md-6">
                            <div class="form-group">
