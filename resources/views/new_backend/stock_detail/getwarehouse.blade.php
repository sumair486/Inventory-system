...
@foreach ($warehouse_stock as $warehouse_stocks)
                        <div class="col-lg-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-12 ms-auto align-self-center">
                                            ...
                                            <a href="{{ route('getwarehouseproduct',$warehouse_stocks->id) }}">
                                            <h2 class="text-dark my-0 font-22 fw-bold">{{ $warehouse_stocks->name }}</h2>
                                        </a>
                                            {{-- <h3 class="text-muted mb-0 fw-semibold">{{ $warehouse_stocks->total_fine_quantity }}</h3> --}}
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </div><!--end card-body-->
                            </div><!--end card-->
