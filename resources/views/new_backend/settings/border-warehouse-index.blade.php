...
<head>
  <meta charset="utf-8"/>
  <title>Border Warehouse List</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">  <a class="btn btn-success" href="{{ route('border.warehouse') }}"> Create Border Warehouse</a></h4>
                            </div><!--end card-header-->
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="datatable_1">
                                        ...
                                        <tbody>
                                            @foreach ($border_warehouse as $key=>$border_warehouses)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td>{{ $border_warehouses->name }}</td>
                                                <td>
                                                    <form action="{{ route('border.warehouse.destroy',$border_warehouses->id) }}" method="POST">
