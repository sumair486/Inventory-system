...
<html lang="en">
    <head>
        ...
        {{-- title --}}
        <meta charset="utf-8"/>
        <title>Add Border Warehouse</title>
        ...
        @endif
            <div class="row ">
                <div class="col-md-12 col-lg-12">
                    ...
                    <form action="{{ route('border.warehouse.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input required type="text" name="name" class="form-control" placeholder="Border Warehouse Name">
                              </div>
                          </div>
