                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="datatable_1">
                                        ...
                                        <tbody>
                                            @foreach ($border_stock as $key=>$border_stocks)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                {{-- <td>{{ $border_stocks->border->address ?? '' }}</td> --}}
                                                <td>{{ $border_stocks->warehouseborder->name ?? '' }}</td>
                                                <td>{{ date('d-m-Y', strtotime($border_stocks->date)) }}</td>

                                                <td>{{ $border_stocks->category->category_name ?? '' }}</td>
                                                <td>{{ $border_stocks->product->product_name ?? '' }}</td>
                                                {{-- <td>{{ $border_stocks->total_quantity}}</td> --}}
                                                <td>{{ $border_stocks->total_quantity}}</td>
                                                ...
                                                <td>
                                                    <form action="{{ route('border.stock.delete',$border_stocks->id) }}" method="POST">
