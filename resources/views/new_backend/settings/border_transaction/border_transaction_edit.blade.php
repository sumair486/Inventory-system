        ...
        @endif
            <div class="row ">
                <div class="col-md-12 col-lg-12">
                    ...
                    <form  id="item-form" action="{{ route('border.transaction.update',$border_edit->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong>Invoice No:</strong>
                                    <input  placeholder="Invoice number" value="{{ $border_edit->invoice_no }}"  type="number" name="invoice_no" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <select required name="border_warehouse_id"  class="form-control">
                                  @foreach ($border_warehouse as $border_warehouses)
                                      <option value="{{ $border_warehouses->id }}"  {{ $border_edit->border_warehouse_id == $border_warehouses->id ? 'selected' : '' }}>
                                        {{ $border_warehouses->name }}</option>
                                  @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong>Date:</strong>
                                    <input value="{{ date('Y-m-d') }}" value="{{ $border_edit->date }}"   type="date" name="date" class="form-control">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {{-- <strong>Image:</strong> --}}
                                <span>  <img src="/border_transaction/{{$border_edit->image}}" width="150px"></span>
