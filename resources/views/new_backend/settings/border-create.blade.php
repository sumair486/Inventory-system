        ...
        @endif
            <div class="row ">
                <div class="col-md-12 col-lg-12">
                    ...
                    <form action="{{ route('border.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" required name="address" class="form-control" placeholder="Address Name">
                              </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <strong>Location:</strong>
                                <input type="text" required name="location" class="form-control" placeholder="Location Name">
                            </div>
                        </div>
