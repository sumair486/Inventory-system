                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="datatable_2">
                                        ...
                                        <tbody>
                                            @foreach ($border_product as $key=>$border_products)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                              <td>{{ $border_products->category->category_name }}</td>
                                              <td>{{ $border_products->product->product_name }}</td>
                                              <td>{{ $border_products->total_quantity }}</td>
                                            ...
                                            <thead class="thead-light">
                                                <tr>
                                                  ...
                                                  <th>Total : {{ $border_product->sum('total_quantity') }}</th>
